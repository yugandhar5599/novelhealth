   ...
   <div class="col-md-6 col-md-offset-3">
    <div class="panel panel-login">
     ...
     <div class="panel-body">
      <div class="row">
       <div class="col-lg-12">
        <form:form id="registration-form" action="./addHospital"  commandName="hospName" method="POST" role="form" style="display: block;">
         ...
         <div class="form-group">
          <div class="row">
           <div class="col-sm-6 col-sm-offset-3">
            <input type="submit"  id="registration-submit" tabindex="4" class="form-control btn btn-registartion" value="Add Hospital">
           </div>
          </div>
         </div>
         <!-- <div class="form-group">
