...
<body>
	<div class="panel panel-success">
		...
		<div class="panel-heading">User Management Board</div>
		...
		<table class="table">
			...
			<c:forEach items="${uiadminslist}" var="userBean">
				<tr>
					...
					<td><a href="./editAdmin?adminId=${userBean.adminId}"><div
								class="glyphicon glyphicon-edit"></div></a></td>
					<td><a href="./deleteAdmin?adminId=${userBean.adminId}"><div
		...
		<%-- <div>
			...
			<ul class="pagination">
				...
				<c:forEach items="${pagePerSize}" varStatus="loop" var="hospBean">
					<li><a
						href="./getAllHospitalsByPaging?currentPage=${loop.count}"> <span
							class="sr-only">(current)</span>${loop.count}
					</a></li>
				</c:forEach>
