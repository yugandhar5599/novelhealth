				...
				<div class="panel panel-login">
					<div class="panel-heading">
						<div class="row">
							<div class="col-xs-6">
								<h3>
									<label class="active" id="login-form-link">ADD Patient</label>
								</h3>
							</div>
					...
					<div class="panel-body">
						<div class="row">
							<div class="col-lg-12">
								<form:form id="registration-form" action="./addPatient"
									commandName="patientBean" method="post" role="form"
									style="display: block;">
									<div class="form-group">
										<form:input path="pId" type="hidden" id="adminId"
									...
									<div class="form-group">
										...
										<form:input path="middleName" type="text" id="firstName"
