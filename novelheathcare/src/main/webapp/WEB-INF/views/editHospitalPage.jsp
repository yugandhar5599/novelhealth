		...
		<div class="bg-color">
			...
			<div class="panel-group" style="padding-right: 300px; padding-left: 250px; padding-bottom: 20px;">
				<div class="panel panel-default">
					<div class="panel-heading" style="background-color: RGBA(13, 70, 83, 0.78); color: white; border-bottom-color: white;" align="center">UPDATE
						HOSPITAL</div>
					<div class="panel-body" align="center">

						<form:form class="form-horizontal" action="./editHospital" commandName="editHospitalForm" method="post">
							<div class="form-group">
								<label class="control-label col-sm-2" for="hospitalId">hospitalId*:</label>
								<div class="col-sm-10" style="padding-right: 200px; padding-bottom: 10px;">
									<form:errors path="hospitalId"></form:errors>
									<form:input type="text" class="form-control" id="hospitalId" placeholder="enter hospital id" path="hospitalId" disabled="false"></form:input>
								</div>
								...
								<label class="control-label col-sm-2" for="fax">Email* :</label>
								<div class="col-sm-10" style="padding-right: 200px; padding-bottom: 10px;">
									<form:errors path="email"></form:errors>
									<form:input type="text" class="form-control" id="email" placeholder="enter email" path="email"></form:input>
								</div>
								...
								<div class="col-sm-10" style="padding-right: 450px; padding-bottom: 20px;">
									<label class="radio-inline" style="color: green;"><form:radiobutton path="status" value="true" />active</label> <label class="radio-inline"
										style="color: red;"> <form:errors path="status"></form:errors> <form:radiobutton path="status" value="false" />in active
									</label>
								</div>
								<div class="col-sm-10" style="padding-left: 100px; padding-bottom: 10px;">
									<button type="submit" class="btn btn-success" style="text-align: center">edit hospital</button>
