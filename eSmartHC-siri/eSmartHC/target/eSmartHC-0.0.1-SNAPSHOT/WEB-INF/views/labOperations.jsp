    ...
    <div class="container-fluid display-table">
        ...
        <div class="table-responsive">
    		...
    		<tbody>
				...
				<core:forEach varStatus="serialno" items="${LabList}" var="labBean">
				<core:set var="lIdkey" value="${labBean.getLabId()}" scope="session"></core:set>
				...
				<td><p data-placement="top" data-toggle="tooltip" title="Delete"><button onclick="deleteUser('${lIdkey}');" class="btn btn-danger btn-xs" data-title="Delete" data-toggle="modal" data-target="#delete" ><span class="glyphicon glyphicon-trash"></span></button></p></td>
				<td><p data-placement="top" data-toggle="tooltip" title="Edit"><a href="${pageContext.request.contextPath}/getAllLabsById?labId=${labBean.getLabId()}" type="button" class="btn btn-primary btn-xs" data-title="Edit" data-toggle="modal" data-target="#edit" ><span class="glyphicon glyphicon-pencil"></span></a></p></td>
				</tr>
				</core:forEach>
				</core:when>
				</core:choose>
   				 ...
   				 <core:choose>
				<core:when test="${not empty labBean}">
...
<div><a href="addLab">Add Lab</a></div>
...
jQuery("#deleteUserYes").on('click', function() {
	...
	jQuery.ajax({
		...
		url : appl_url + "/deleteLabById",
		success : function(result) {
			//alert("result "+result);
			 window.location=appl_url+"/getEditLabPage"; 
				}
	});
});
