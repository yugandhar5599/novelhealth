    ...
    <div class="container-fluid display-table">
        ...
        <div class="table-responsive">
    		...
    		<tbody>
				...
				<core:forEach varStatus="loop" items="${PharmaList}" var="pharmaBean">
				<core:set var="absKey" value="${pharmaBean.getPharmaId()}" scope="session" />
				<tr>
				<!-- <td></td> -->
				<th><input type="checkbox" id="checkall" /></th>
				<td>${loop.index+1}</td>
...
<div><a href="addPharma">Add Pharma</a></div>
...
jQuery("#deleteUserYes").on('click', function() {
	var pharmaId = jQuery("#userId").val();
	jQuery.ajax({
		cache : false,
		type : "POST",
		datatype:'json',
		...
		url : appl_url + "/deletePharmaById",
		success : function(result) {
			//alert("result "+result);
			 window.location=appl_url+"/getEditPharmaPage"; 
				}
	});
});
