        ...
        <div class="table-responsive">
              ...
              <table id="mytable" class="table table-bordred table-striped">
                  ...
                  <th style="color: blue">SNo</th>
					<th style="color: blue">StaffName</th>
    		...
    		<tbody>
				...
				<core:forEach varStatus="sno" items="${StaffList}" var="staffBean">
				<core:set var="sIdkey" value="${staffBean.getStaffId()}" scope="session"></core:set>
				...
				<td><p data-placement="top" data-toggle="tooltip" title="Delete"><button onclick="deleteUser('${sIdkey}');" class="btn btn-danger btn-xs" data-title="Delete" data-toggle="modal" data-target="#delete" ><span class="glyphicon glyphicon-trash"></span></button></p></td>
...
<div><a href="addStaff">Add Staff</a></div>
...
jQuery("#deleteUserYes").on('click', function() {
	...
	jQuery.ajax({
		...
		url : appl_url + "/deleteStaffById",
		success : function(result) {
			//alert("result "+result);
			 window.location=appl_url+"/getEditStaffPage"; 
				}
	});
});
