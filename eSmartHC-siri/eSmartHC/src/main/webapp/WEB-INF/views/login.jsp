			...
			<div class="col-md-6 col-md-offset-3">
				<div class="panel panel-login">
					...
					<div class="panel-body">
						<div class="row">
							<div class="col-lg-12">
								<%-- <form:form id="login-form" action="getAllUserProcessInfo"  commandName="loginBean" method="GET" role="form" style="display: block;">
								...
								<form id="login-form" action="./j_spring_security_check" method="post" role="form" style="display: block;">
									<div class="form-group">
										<input name="j_username" type="text"  id="username" tabindex="1" class="form-control" placeholder="Username" value=""></input>
									</div>
									<div class="form-group">
										<input name="j_password" type="password"  id="password" tabindex="2" class="form-control" placeholder="Password"></input>
									</div>
									<div class="form-group text-center">
										<input type="checkbox" tabindex="3" class="" name="remember" id="remember">
										<label for="remember"> Remember Me</label>
